...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    int total_num_views = self.jenkinsViews.count;
    CGFloat pageWidth = self->jenkinsViewsScrollView.frame.size.width;
    float fractionalPage = self->jenkinsViewsScrollView.contentOffset.x / pageWidth;
    NSInteger page = lround(fractionalPage)+1;
    
    
    [label setText:[NSString stringWithFormat:@"%d%@%d",page,@"/",total_num_views]];
